...
set script_file "vivado_generate_project_75t.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/NVM_Express_Pcileech_FPGA_75T"]"
...
set files [list \
 ...
 [file normalize "${origin_dir}/src/nvm_express_pcileech_fpga_75t_top.sv"]\
]
...
set file "src/nvm_express_pcileech_fpga_75t_top.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set obj [get_filesets sources_1]
set_property -name "top" -value "nvm_express_pcileech_fpga_75t_top" -objects $obj
...
set file "[file normalize ${origin_dir}/src/nvm_express_pcileech_fpga_75t.xdc]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "src/nvm_express_pcileech_fpga_75t.xdc"
